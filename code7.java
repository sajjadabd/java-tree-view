...
public class code7
{
    ...
    public code7(BufferedImage[] images)
    {
        this.images = images;
    }
    ...
    private JTree getLeftTree()
    {
        ...
        final Font currentFont = renderer.getFont();
        final Font bigFont = new Font(currentFont.getName(), currentFont.getStyle(), currentFont.getSize() + 20);
    ...
    private JTree getRightTree()
    {
        ...
        tree.putClientProperty("JTree.lineStyle", "dashed");
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        UIManager.put("Tree.leftChildIndent" ,  30 );
        // UIManager.put("Tree.paintLines", Boolean.TRUE); // Disable default lines
        // UIManager.put("Tree.lineTypeDashed", Boolean.TRUE);
        // UIManager.put("Tree.line", new ColorUIResource(Color.BLACK));

        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        f.setContentPane(new code7(bis).getContent());
        f.setSize(500,400);
...
class IconRenderer extends DefaultTreeCellRenderer
{
                                                  ...
                                                  boolean hasFocus)
    {
        ...
        Font font = getFont();
        setFont(font.deriveFont((float) 20));
